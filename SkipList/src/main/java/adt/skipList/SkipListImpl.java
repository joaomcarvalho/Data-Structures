...
public class SkipListImpl<T> implements SkipList<T> {
	...
	public void insert(int key, T newValue, int height) {
		...
		if(aux.getKey() == key){
			...
			changeRefers(height, update, aux);
		}
	}
	
	private void ajust (int height, SkipListNode<T>[] update){
	...
	private void changeRefers(int height, SkipListNode<T>[] update, SkipListNode<T> aux){
